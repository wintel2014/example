...
template< typename T0 , typename T1>
MemoryLogCore* Create( const String16& column0 , const String16& column1,uint32_t nMaxBufferLog = 137)
{
    typedef boost::fusion::vector< T0 , T1> LogType;
    uint32_t nLength = MemoryLogCore::GetSize(2,sizeof(LogType),nMaxBufferLog);
    if((mCurrentAddress + nLength) > mEndAddress)
    {
       return nullptr;
    }
    MemoryLogCore* pLogCore = new (mCurrentAddress)MemoryLogCore(2,sizeof(LogType),nMaxBufferLog);
    LogType tempV;
    pLogCore->GetDescriptor().SetColumnInfo(0 ,MemoryTypeCode<T0>::Code ,(uint8_t*)&boost::fusion::at_c<0>(tempV) - (uint8_t*)&tempV ,column0); pLogCore->GetDescriptor().SetColumnInfo(1 ,MemoryTypeCode<T1>::Code ,(uint8_t*)&boost::fusion::at_c<1>(tempV) - (uint8_t*)&tempV ,column1);
    mCurrentAddress += nLength;
    BOOST_ASSERT(mCurrentAddress == pLogCore->GetLogAddress(nMaxBufferLog));
    return pLogCore;
}
template< typename T0 , typename T1 , typename T2>
MemoryLogCore* Create( const String16& column0 , const String16& column1 , const String16& column2,uint32_t nMaxBufferLog = 137)
{
    typedef boost::fusion::vector< T0 , T1 , T2> LogType;
    uint32_t nLength = MemoryLogCore::GetSize(3,sizeof(LogType),nMaxBufferLog);
    if((mCurrentAddress + nLength) > mEndAddress)
    {
       return nullptr;
    }
    MemoryLogCore* pLogCore = new (mCurrentAddress)MemoryLogCore(3,sizeof(LogType),nMaxBufferLog);
    LogType tempV;
    pLogCore->GetDescriptor().SetColumnInfo(0 ,MemoryTypeCode<T0>::Code ,(uint8_t*)&boost::fusion::at_c<0>(tempV) - (uint8_t*)&tempV ,column0); pLogCore->GetDescriptor().SetColumnInfo(1 ,MemoryTypeCode<T1>::Code ,(uint8_t*)&boost::fusion::at_c<1>(tempV) - (uint8_t*)&tempV ,column1); pLogCore->GetDescriptor().SetColumnInfo(2 ,MemoryTypeCode<T2>::Code ,(uint8_t*)&boost::fusion::at_c<2>(tempV) - (uint8_t*)&tempV ,column2);
    mCurrentAddress += nLength;
    BOOST_ASSERT(mCurrentAddress == pLogCore->GetLogAddress(nMaxBufferLog));
    return pLogCore;
}
template< typename T0 , typename T1 , typename T2 , typename T3>
MemoryLogCore* Create( const String16& column0 , const String16& column1 , const String16& column2 , const String16& column3,uint32_t nMaxBufferLog = 137)
{
    typedef boost::fusion::vector< T0 , T1 , T2 , T3> LogType;
    uint32_t nLength = MemoryLogCore::GetSize(4,sizeof(LogType),nMaxBufferLog);
    if((mCurrentAddress + nLength) > mEndAddress)
    {
       return nullptr;
    }
    MemoryLogCore* pLogCore = new (mCurrentAddress)MemoryLogCore(4,sizeof(LogType),nMaxBufferLog);
    LogType tempV;
    pLogCore->GetDescriptor().SetColumnInfo(0 ,MemoryTypeCode<T0>::Code ,(uint8_t*)&boost::fusion::at_c<0>(tempV) - (uint8_t*)&tempV ,column0); pLogCore->GetDescriptor().SetColumnInfo(1 ,MemoryTypeCode<T1>::Code ,(uint8_t*)&boost::fusion::at_c<1>(tempV) - (uint8_t*)&tempV ,column1); pLogCore->GetDescriptor().SetColumnInfo(2 ,MemoryTypeCode<T2>::Code ,(uint8_t*)&boost::fusion::at_c<2>(tempV) - (uint8_t*)&tempV ,column2); pLogCore->GetDescriptor().SetColumnInfo(3 ,MemoryTypeCode<T3>::Code ,(uint8_t*)&boost::fusion::at_c<3>(tempV) - (uint8_t*)&tempV ,column3);
    mCurrentAddress += nLength;
    BOOST_ASSERT(mCurrentAddress == pLogCore->GetLogAddress(nMaxBufferLog));
    return pLogCore;
}
template< typename T0 , typename T1 , typename T2 , typename T3 , typename T4>
MemoryLogCore* Create( const String16& column0 , const String16& column1 , const String16& column2 , const String16& column3 , const String16& column4,uint32_t nMaxBufferLog = 137)
{
    typedef boost::fusion::vector< T0 , T1 , T2 , T3 , T4> LogType;
    uint32_t nLength = MemoryLogCore::GetSize(5,sizeof(LogType),nMaxBufferLog);
    if((mCurrentAddress + nLength) > mEndAddress)
    {
       return nullptr;
    }
    MemoryLogCore* pLogCore = new (mCurrentAddress)MemoryLogCore(5,sizeof(LogType),nMaxBufferLog);
    LogType tempV;
    pLogCore->GetDescriptor().SetColumnInfo(0 ,MemoryTypeCode<T0>::Code ,(uint8_t*)&boost::fusion::at_c<0>(tempV) - (uint8_t*)&tempV ,column0); pLogCore->GetDescriptor().SetColumnInfo(1 ,MemoryTypeCode<T1>::Code ,(uint8_t*)&boost::fusion::at_c<1>(tempV) - (uint8_t*)&tempV ,column1); pLogCore->GetDescriptor().SetColumnInfo(2 ,MemoryTypeCode<T2>::Code ,(uint8_t*)&boost::fusion::at_c<2>(tempV) - (uint8_t*)&tempV ,column2); pLogCore->GetDescriptor().SetColumnInfo(3 ,MemoryTypeCode<T3>::Code ,(uint8_t*)&boost::fusion::at_c<3>(tempV) - (uint8_t*)&tempV ,column3); pLogCore->GetDescriptor().SetColumnInfo(4 ,MemoryTypeCode<T4>::Code ,(uint8_t*)&boost::fusion::at_c<4>(tempV) - (uint8_t*)&tempV ,column4);
    mCurrentAddress += nLength;
    BOOST_ASSERT(mCurrentAddress == pLogCore->GetLogAddress(nMaxBufferLog));
    return pLogCore;
}
template< typename T0 , typename T1 , typename T2 , typename T3 , typename T4 , typename T5>
MemoryLogCore* Create( const String16& column0 , const String16& column1 , const String16& column2 , const String16& column3 , const String16& column4 , const String16& column5,uint32_t nMaxBufferLog = 137)
{
    typedef boost::fusion::vector< T0 , T1 , T2 , T3 , T4 , T5> LogType;
    uint32_t nLength = MemoryLogCore::GetSize(6,sizeof(LogType),nMaxBufferLog);
    if((mCurrentAddress + nLength) > mEndAddress)
    {
       return nullptr;
    }
    MemoryLogCore* pLogCore = new (mCurrentAddress)MemoryLogCore(6,sizeof(LogType),nMaxBufferLog);
    LogType tempV;
    pLogCore->GetDescriptor().SetColumnInfo(0 ,MemoryTypeCode<T0>::Code ,(uint8_t*)&boost::fusion::at_c<0>(tempV) - (uint8_t*)&tempV ,column0); pLogCore->GetDescriptor().SetColumnInfo(1 ,MemoryTypeCode<T1>::Code ,(uint8_t*)&boost::fusion::at_c<1>(tempV) - (uint8_t*)&tempV ,column1); pLogCore->GetDescriptor().SetColumnInfo(2 ,MemoryTypeCode<T2>::Code ,(uint8_t*)&boost::fusion::at_c<2>(tempV) - (uint8_t*)&tempV ,column2); pLogCore->GetDescriptor().SetColumnInfo(3 ,MemoryTypeCode<T3>::Code ,(uint8_t*)&boost::fusion::at_c<3>(tempV) - (uint8_t*)&tempV ,column3); pLogCore->GetDescriptor().SetColumnInfo(4 ,MemoryTypeCode<T4>::Code ,(uint8_t*)&boost::fusion::at_c<4>(tempV) - (uint8_t*)&tempV ,column4); pLogCore->GetDescriptor().SetColumnInfo(5 ,MemoryTypeCode<T5>::Code ,(uint8_t*)&boost::fusion::at_c<5>(tempV) - (uint8_t*)&tempV ,column5);
    mCurrentAddress += nLength;
    BOOST_ASSERT(mCurrentAddress == pLogCore->GetLogAddress(nMaxBufferLog));
    return pLogCore;
}
template< typename T0 , typename T1 , typename T2 , typename T3 , typename T4 , typename T5 , typename T6>
MemoryLogCore* Create( const String16& column0 , const String16& column1 , const String16& column2 , const String16& column3 , const String16& column4 , const String16& column5 , const String16& column6,uint32_t nMaxBufferLog = 137)
{
    typedef boost::fusion::vector< T0 , T1 , T2 , T3 , T4 , T5 , T6> LogType;
    uint32_t nLength = MemoryLogCore::GetSize(7,sizeof(LogType),nMaxBufferLog);
    if((mCurrentAddress + nLength) > mEndAddress)
    {
       return nullptr;
    }
    MemoryLogCore* pLogCore = new (mCurrentAddress)MemoryLogCore(7,sizeof(LogType),nMaxBufferLog);
    LogType tempV;
    pLogCore->GetDescriptor().SetColumnInfo(0 ,MemoryTypeCode<T0>::Code ,(uint8_t*)&boost::fusion::at_c<0>(tempV) - (uint8_t*)&tempV ,column0); pLogCore->GetDescriptor().SetColumnInfo(1 ,MemoryTypeCode<T1>::Code ,(uint8_t*)&boost::fusion::at_c<1>(tempV) - (uint8_t*)&tempV ,column1); pLogCore->GetDescriptor().SetColumnInfo(2 ,MemoryTypeCode<T2>::Code ,(uint8_t*)&boost::fusion::at_c<2>(tempV) - (uint8_t*)&tempV ,column2); pLogCore->GetDescriptor().SetColumnInfo(3 ,MemoryTypeCode<T3>::Code ,(uint8_t*)&boost::fusion::at_c<3>(tempV) - (uint8_t*)&tempV ,column3); pLogCore->GetDescriptor().SetColumnInfo(4 ,MemoryTypeCode<T4>::Code ,(uint8_t*)&boost::fusion::at_c<4>(tempV) - (uint8_t*)&tempV ,column4); pLogCore->GetDescriptor().SetColumnInfo(5 ,MemoryTypeCode<T5>::Code ,(uint8_t*)&boost::fusion::at_c<5>(tempV) - (uint8_t*)&tempV ,column5); pLogCore->GetDescriptor().SetColumnInfo(6 ,MemoryTypeCode<T6>::Code ,(uint8_t*)&boost::fusion::at_c<6>(tempV) - (uint8_t*)&tempV ,column6);
    mCurrentAddress += nLength;
    BOOST_ASSERT(mCurrentAddress == pLogCore->GetLogAddress(nMaxBufferLog));
    return pLogCore;
}
template< typename T0 , typename T1 , typename T2 , typename T3 , typename T4 , typename T5 , typename T6 , typename T7>
MemoryLogCore* Create( const String16& column0 , const String16& column1 , const String16& column2 , const String16& column3 , const String16& column4 , const String16& column5 , const String16& column6 , const String16& column7,uint32_t nMaxBufferLog = 137)
{
    typedef boost::fusion::vector< T0 , T1 , T2 , T3 , T4 , T5 , T6 , T7> LogType;
    uint32_t nLength = MemoryLogCore::GetSize(8,sizeof(LogType),nMaxBufferLog);
    if((mCurrentAddress + nLength) > mEndAddress)
    {
       return nullptr;
    }
    MemoryLogCore* pLogCore = new (mCurrentAddress)MemoryLogCore(8,sizeof(LogType),nMaxBufferLog);
    LogType tempV;
    pLogCore->GetDescriptor().SetColumnInfo(0 ,MemoryTypeCode<T0>::Code ,(uint8_t*)&boost::fusion::at_c<0>(tempV) - (uint8_t*)&tempV ,column0); pLogCore->GetDescriptor().SetColumnInfo(1 ,MemoryTypeCode<T1>::Code ,(uint8_t*)&boost::fusion::at_c<1>(tempV) - (uint8_t*)&tempV ,column1); pLogCore->GetDescriptor().SetColumnInfo(2 ,MemoryTypeCode<T2>::Code ,(uint8_t*)&boost::fusion::at_c<2>(tempV) - (uint8_t*)&tempV ,column2); pLogCore->GetDescriptor().SetColumnInfo(3 ,MemoryTypeCode<T3>::Code ,(uint8_t*)&boost::fusion::at_c<3>(tempV) - (uint8_t*)&tempV ,column3); pLogCore->GetDescriptor().SetColumnInfo(4 ,MemoryTypeCode<T4>::Code ,(uint8_t*)&boost::fusion::at_c<4>(tempV) - (uint8_t*)&tempV ,column4); pLogCore->GetDescriptor().SetColumnInfo(5 ,MemoryTypeCode<T5>::Code ,(uint8_t*)&boost::fusion::at_c<5>(tempV) - (uint8_t*)&tempV ,column5); pLogCore->GetDescriptor().SetColumnInfo(6 ,MemoryTypeCode<T6>::Code ,(uint8_t*)&boost::fusion::at_c<6>(tempV) - (uint8_t*)&tempV ,column6); pLogCore->GetDescriptor().SetColumnInfo(7 ,MemoryTypeCode<T7>::Code ,(uint8_t*)&boost::fusion::at_c<7>(tempV) - (uint8_t*)&tempV ,column7);
    mCurrentAddress += nLength;
    BOOST_ASSERT(mCurrentAddress == pLogCore->GetLogAddress(nMaxBufferLog));
    return pLogCore;
}
template< typename T0 , typename T1 , typename T2 , typename T3 , typename T4 , typename T5 , typename T6 , typename T7 , typename T8>
MemoryLogCore* Create( const String16& column0 , const String16& column1 , const String16& column2 , const String16& column3 , const String16& column4 , const String16& column5 , const String16& column6 , const String16& column7 , const String16& column8,uint32_t nMaxBufferLog = 137)
{
    typedef boost::fusion::vector< T0 , T1 , T2 , T3 , T4 , T5 , T6 , T7 , T8> LogType;
    uint32_t nLength = MemoryLogCore::GetSize(9,sizeof(LogType),nMaxBufferLog);
    if((mCurrentAddress + nLength) > mEndAddress)
    {
       return nullptr;
    }
    MemoryLogCore* pLogCore = new (mCurrentAddress)MemoryLogCore(9,sizeof(LogType),nMaxBufferLog);
    LogType tempV;
    pLogCore->GetDescriptor().SetColumnInfo(0 ,MemoryTypeCode<T0>::Code ,(uint8_t*)&boost::fusion::at_c<0>(tempV) - (uint8_t*)&tempV ,column0); pLogCore->GetDescriptor().SetColumnInfo(1 ,MemoryTypeCode<T1>::Code ,(uint8_t*)&boost::fusion::at_c<1>(tempV) - (uint8_t*)&tempV ,column1); pLogCore->GetDescriptor().SetColumnInfo(2 ,MemoryTypeCode<T2>::Code ,(uint8_t*)&boost::fusion::at_c<2>(tempV) - (uint8_t*)&tempV ,column2); pLogCore->GetDescriptor().SetColumnInfo(3 ,MemoryTypeCode<T3>::Code ,(uint8_t*)&boost::fusion::at_c<3>(tempV) - (uint8_t*)&tempV ,column3); pLogCore->GetDescriptor().SetColumnInfo(4 ,MemoryTypeCode<T4>::Code ,(uint8_t*)&boost::fusion::at_c<4>(tempV) - (uint8_t*)&tempV ,column4); pLogCore->GetDescriptor().SetColumnInfo(5 ,MemoryTypeCode<T5>::Code ,(uint8_t*)&boost::fusion::at_c<5>(tempV) - (uint8_t*)&tempV ,column5); pLogCore->GetDescriptor().SetColumnInfo(6 ,MemoryTypeCode<T6>::Code ,(uint8_t*)&boost::fusion::at_c<6>(tempV) - (uint8_t*)&tempV ,column6); pLogCore->GetDescriptor().SetColumnInfo(7 ,MemoryTypeCode<T7>::Code ,(uint8_t*)&boost::fusion::at_c<7>(tempV) - (uint8_t*)&tempV ,column7); pLogCore->GetDescriptor().SetColumnInfo(8 ,MemoryTypeCode<T8>::Code ,(uint8_t*)&boost::fusion::at_c<8>(tempV) - (uint8_t*)&tempV ,column8);
    mCurrentAddress += nLength;
    BOOST_ASSERT(mCurrentAddress == pLogCore->GetLogAddress(nMaxBufferLog));
    return pLogCore;
}
template< typename T0 , typename T1 , typename T2 , typename T3 , typename T4 , typename T5 , typename T6 , typename T7 , typename T8 , typename T9>
MemoryLogCore* Create( const String16& column0 , const String16& column1 , const String16& column2 , const String16& column3 , const String16& column4 , const String16& column5 , const String16& column6 , const String16& column7 , const String16& column8 , const String16& column9,uint32_t nMaxBufferLog = 137)
{
    typedef boost::fusion::vector< T0 , T1 , T2 , T3 , T4 , T5 , T6 , T7 , T8 , T9> LogType;
    uint32_t nLength = MemoryLogCore::GetSize(10,sizeof(LogType),nMaxBufferLog);
    if((mCurrentAddress + nLength) > mEndAddress)
    {
       return nullptr;
    }
    MemoryLogCore* pLogCore = new (mCurrentAddress)MemoryLogCore(10,sizeof(LogType),nMaxBufferLog);
    LogType tempV;
    pLogCore->GetDescriptor().SetColumnInfo(0 ,MemoryTypeCode<T0>::Code ,(uint8_t*)&boost::fusion::at_c<0>(tempV) - (uint8_t*)&tempV ,column0); pLogCore->GetDescriptor().SetColumnInfo(1 ,MemoryTypeCode<T1>::Code ,(uint8_t*)&boost::fusion::at_c<1>(tempV) - (uint8_t*)&tempV ,column1); pLogCore->GetDescriptor().SetColumnInfo(2 ,MemoryTypeCode<T2>::Code ,(uint8_t*)&boost::fusion::at_c<2>(tempV) - (uint8_t*)&tempV ,column2); pLogCore->GetDescriptor().SetColumnInfo(3 ,MemoryTypeCode<T3>::Code ,(uint8_t*)&boost::fusion::at_c<3>(tempV) - (uint8_t*)&tempV ,column3); pLogCore->GetDescriptor().SetColumnInfo(4 ,MemoryTypeCode<T4>::Code ,(uint8_t*)&boost::fusion::at_c<4>(tempV) - (uint8_t*)&tempV ,column4); pLogCore->GetDescriptor().SetColumnInfo(5 ,MemoryTypeCode<T5>::Code ,(uint8_t*)&boost::fusion::at_c<5>(tempV) - (uint8_t*)&tempV ,column5); pLogCore->GetDescriptor().SetColumnInfo(6 ,MemoryTypeCode<T6>::Code ,(uint8_t*)&boost::fusion::at_c<6>(tempV) - (uint8_t*)&tempV ,column6); pLogCore->GetDescriptor().SetColumnInfo(7 ,MemoryTypeCode<T7>::Code ,(uint8_t*)&boost::fusion::at_c<7>(tempV) - (uint8_t*)&tempV ,column7); pLogCore->GetDescriptor().SetColumnInfo(8 ,MemoryTypeCode<T8>::Code ,(uint8_t*)&boost::fusion::at_c<8>(tempV) - (uint8_t*)&tempV ,column8); pLogCore->GetDescriptor().SetColumnInfo(9 ,MemoryTypeCode<T9>::Code ,(uint8_t*)&boost::fusion::at_c<9>(tempV) - (uint8_t*)&tempV ,column9);
    mCurrentAddress += nLength;
    BOOST_ASSERT(mCurrentAddress == pLogCore->GetLogAddress(nMaxBufferLog));
    return pLogCore;
}
